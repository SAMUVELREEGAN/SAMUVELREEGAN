export const processSteps = [
  { id: 1, label: 'Blueprint', style: 'filled' },
  { id: 2, label: 'Frontend', style: 'outline' },
  { id: 3, label: 'Backend', style: 'filled' },
  { id: 4, label: 'Mobile', style: 'outline' },
  { id: 5, label: 'Deploy', style: 'filled' },
];
...
export const footerCta = "Let's build something MEANINGFUL together.";
